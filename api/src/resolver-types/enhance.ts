...
const modelsInfo = {
  User: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "profileId", "posts", "likedPosts", "likedComments", "PostComment", "Post", "postId"],
  UserOrderByInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
  UserWhereUniqueInput: ["id", "username", "email"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
  UserProfileWhereInput: ["AND", "OR", "NOT", "id", "updatedAt", "user", "avatarUrl", "bio"],
  ...
  UserCreateInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "PostComment", "Post"],
  UserUpdateInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "PostComment", "Post"],
  UserCreateManyInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
  UserUpdateManyMutationInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole"],
  UserProfileCreateInput: ["id", "updatedAt", "avatarUrl", "bio", "user"],
  UserProfileUpdateInput: ["updatedAt", "avatarUrl", "bio", "user"],
  ...
  UserProfileCreateWithoutUserInput: ["id", "updatedAt", "avatarUrl", "bio"],
  ...
  UserProfileUpdateWithoutUserInput: ["updatedAt", "avatarUrl", "bio"],
  ...
  UserCreateWithoutProfileInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "posts", "likedPosts", "likedComments", "PostComment", "Post"],
  UserCreateOrConnectWithoutProfileInput: ["where", "create"],
  UserUpsertWithoutProfileInput: ["update", "create"],
  UserUpdateWithoutProfileInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "posts", "likedPosts", "likedComments", "PostComment", "Post"],
  UserCreateWithoutPostInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "PostComment"],
  ...
  UserCreateWithoutPostsInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "likedPosts", "likedComments", "PostComment", "Post"],
  UserCreateOrConnectWithoutPostsInput: ["where", "create"],
  UserCreateWithoutLikedPostsInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedComments", "PostComment", "Post"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
  ...
  UserUpdateWithoutPostsInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "likedPosts", "likedComments", "PostComment", "Post"],
  UserUpsertWithoutLikedPostsInput: ["update", "create"],
  UserUpdateWithoutLikedPostsInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedComments", "PostComment", "Post"],
  UserCreateWithoutPostCommentInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "Post"],
  ...
  UserCreateWithoutLikedCommentsInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "PostComment", "Post"],
  UserCreateOrConnectWithoutLikedCommentsInput: ["where", "create"],
  UserUpsertWithoutPostCommentInput: ["update", "create"],
  UserUpdateWithoutPostCommentInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "Post"],
  ...
  UserCreateManyPostInput: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId"],
  PostCommentCreateManyPostInput: ["id", "body", "creatorId", "createdAt", "updatedAt", "edited", "likes"],
  UserUpdateWithoutPostInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "PostComment"],
  PostCommentUpdateWithoutPostInput: ["body", "createdAt", "updatedAt", "edited", "likes", "creator", "likers"],
  UserUpdateWithoutLikedCommentsInput: ["createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "PostComment", "Post"]
};
const outputsInfo = {
  AggregateUser: ["_count", "_min", "_max"],
  UserGroupBy: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId", "_count", "_min", "_max"],
  ...
  UserCountAggregate: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId", "_all"],
  UserMinAggregate: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
  UserMaxAggregate: ["id", "createdAt", "updatedAt", "username", "displayName", "email", "password", "userRole", "profileId", "postId"],
