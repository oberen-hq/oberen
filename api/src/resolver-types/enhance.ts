...
const relationResolversInfo = {
  User: ["profile", "posts", "likedPosts", "likedComments", "Post", "PostComment"],
  UserProfile: ["user"],
  Post: ["likers", "comments", "creator", "User"],
  PostComment: ["creator", "post", "likers"]
};
const modelsInfo = {
  User: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "profileId", "posts", "likedPosts", "likedComments", "Post", "postId", "PostComment"],
  UserOrderByInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
  UserWhereUniqueInput: ["id", "username", "email"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
  ...
  UserCreateInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "likedComments", "Post", "PostComment"],
  UserUpdateInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "likedComments", "Post", "PostComment"],
  UserCreateManyInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
  UserUpdateManyMutationInput: ["createdAt", "updatedAt", "username", "email", "UserRole"],
  ...
  UserCreateWithoutProfileInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "posts", "likedPosts", "likedComments", "Post", "PostComment"],
  UserCreateOrConnectWithoutProfileInput: ["where", "create"],
  UserUpsertWithoutProfileInput: ["update", "create"],
  UserUpdateWithoutProfileInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "posts", "likedPosts", "likedComments", "Post", "PostComment"],
  UserCreateWithoutPostInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "likedComments", "PostComment"],
  ...
  UserCreateWithoutPostsInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "likedPosts", "likedComments", "Post", "PostComment"],
  UserCreateOrConnectWithoutPostsInput: ["where", "create"],
  UserCreateWithoutLikedPostsInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedComments", "Post", "PostComment"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
  ...
  UserUpdateWithoutPostsInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "profile", "likedPosts", "likedComments", "Post", "PostComment"],
  UserUpsertWithoutLikedPostsInput: ["update", "create"],
  UserUpdateWithoutLikedPostsInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedComments", "Post", "PostComment"],
  UserCreateWithoutPostCommentInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "likedComments", "Post"],
  ...
  UserCreateWithoutLikedCommentsInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "Post", "PostComment"],
  UserCreateOrConnectWithoutLikedCommentsInput: ["where", "create"],
  UserUpsertWithoutPostCommentInput: ["update", "create"],
  UserUpdateWithoutPostCommentInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "likedComments", "Post"],
  ...
  UserCreateManyPostInput: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId"],
  PostCommentCreateManyPostInput: ["id", "body", "creatorId", "createdAt", "updatedAt", "edited", "likes"],
  UserUpdateWithoutPostInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "likedComments", "PostComment"],
  PostCommentUpdateWithoutPostInput: ["body", "createdAt", "updatedAt", "edited", "likes", "creator", "likers"],
  UserUpdateWithoutLikedCommentsInput: ["createdAt", "updatedAt", "username", "email", "UserRole", "profile", "posts", "likedPosts", "Post", "PostComment"]
};
const outputsInfo = {
  AggregateUser: ["_count", "_min", "_max"],
  UserGroupBy: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId", "_count", "_min", "_max"],
  ...
  UserCountAggregate: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId", "_all"],
  UserMinAggregate: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
  UserMaxAggregate: ["id", "createdAt", "updatedAt", "username", "email", "UserRole", "profileId", "postId"],
