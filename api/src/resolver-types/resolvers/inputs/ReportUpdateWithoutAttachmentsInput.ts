...
import { UserUpdateOneRequiredWithoutReportsInput } from "../inputs/UserUpdateOneRequiredWithoutReportsInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class ReportUpdateWithoutAttachmentsInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneRequiredWithoutReportsInput, {
    nullable: true
  })
  creator?: UserUpdateOneRequiredWithoutReportsInput | undefined;
