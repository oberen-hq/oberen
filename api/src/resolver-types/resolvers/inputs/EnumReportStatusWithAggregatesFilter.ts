...
import { NestedEnumReportStatusWithAggregatesFilter } from "../inputs/NestedEnumReportStatusWithAggregatesFilter";
...
export class EnumReportStatusWithAggregatesFilter {
