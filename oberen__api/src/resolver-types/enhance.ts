...
const modelsInfo = {
  ...
  Post: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "creatorId"],
  ...
  User: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
...
const inputsInfo = {
  ...
  PostWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "title", "description", "type", "likers", "likerIds", "comments", "attachments", "creator", "creatorId"],
  PostOrderByInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "creatorId"],
  PostWhereUniqueInput: ["id"],
  PostScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "creatorId"],
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "profileId", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserOrderByInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
  UserWhereUniqueInput: ["id", "username", "email"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
  ...
  PostCreateInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "comments", "attachments", "creator"],
  PostUpdateInput: ["createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "comments", "attachments", "creator"],
  PostCreateManyInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "creatorId", "likerIds"],
  PostUpdateManyMutationInput: ["createdAt", "updatedAt", "title", "description", "type", "likerIds"],
  ...
  UserCreateInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserUpdateInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserCreateManyInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
  UserUpdateManyMutationInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role"],
  ...
  PostUpdatelikerIdsInput: ["set", "push"],
  ...
  PostCreateManylikerIdsInput: ["set"],
  ...
  PostCreateWithoutAttachmentsInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "comments", "creator"],
  ...
  UserCreateWithoutCreatedAttachmentsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutCreatedAttachmentsInput: ["where", "create"],
  PostUpsertWithoutAttachmentsInput: ["update", "create"],
  PostUpdateWithoutAttachmentsInput: ["createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "comments", "creator"],
  ...
  UserUpdateWithoutCreatedAttachmentsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserCreateWithoutCreatedCommentsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutCreatedCommentsInput: ["where", "create"],
  PostCreateWithoutCommentsInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "attachments", "creator"],
  ...
  UserCreateWithoutLikedCommentsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutLikedCommentsInput: ["where", "create"],
  UserUpsertWithoutCreatedCommentsInput: ["update", "create"],
  UserUpdateWithoutCreatedCommentsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  PostUpsertWithoutCommentsInput: ["update", "create"],
  PostUpdateWithoutCommentsInput: ["createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "attachments", "creator"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
  UserCreateWithoutCreatedLabelsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutCreatedLabelsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserProfileUpsertWithoutLabelsInput: ["update", "create"],
  UserProfileUpdateWithoutLabelsInput: ["updatedAt", "status", "avatarUrl", "bio", "user"],
  UserCreateWithoutOauthConnectionsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "tokens"],
  UserCreateOrConnectWithoutOauthConnectionsInput: ["where", "create"],
  UserUpsertWithoutOauthConnectionsInput: ["update", "create"],
  UserUpdateWithoutOauthConnectionsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "tokens"],
  UserCreateWithoutLikedPostsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  UserCreateWithoutPostsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutPostsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserCreateWithoutReportsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutReportsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "oauthConnections", "tokens"],
  ...
  UserCreateWithoutTokensInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections"],
  UserCreateOrConnectWithoutTokensInput: ["where", "create"],
  UserUpsertWithoutTokensInput: ["update", "create"],
  UserUpdateWithoutTokensInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections"],
  ...
  PostCreateWithoutCreatorInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "comments", "attachments"],
  ...
  PostCreateWithoutLikersInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "comments", "attachments", "creator"],
  ...
  UserCreateWithoutFollowersInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutFollowersInput: ["where", "create"],
  UserCreateWithoutFollowingInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  PostScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "creatorId"],
  ...
  UserCreateWithoutProfileInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutProfileInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutLikedCommentsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutLikedPostsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedComments", "following", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  ...
  PostCreateManyCreatorInput: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds"],
  ...
  PostUpdateWithoutCreatorInput: ["createdAt", "updatedAt", "title", "description", "type", "likerIds", "likers", "comments", "attachments"],
  CommentUpdateWithoutCreatorInput: ["createdAt", "updatedAt", "body", "edited", "likes", "post", "report", "likers"],
  PostUpdateWithoutLikersInput: ["createdAt", "updatedAt", "title", "description", "type", "likerIds", "comments", "attachments", "creator"],
  CommentUpdateWithoutLikersInput: ["createdAt", "updatedAt", "body", "edited", "likes", "creator", "post", "report"],
  UserUpdateWithoutFollowersInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
  UserUpdateWithoutFollowingInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profile", "posts", "createdComments", "likedPosts", "likedComments", "followers", "createdLabels", "createdAttachments", "reports", "oauthConnections", "tokens"],
...
const outputsInfo = {
  ...
  PostGroupBy: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "creatorId", "_count", "_min", "_max"],
  ...
  UserGroupBy: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId", "_count", "_min", "_max"],
  ...
  PostCountAggregate: ["id", "createdAt", "updatedAt", "title", "description", "type", "likerIds", "creatorId", "_all"],
  ...
  UserCountAggregate: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId", "_all"],
  UserMinAggregate: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
  UserMaxAggregate: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "role", "profileId"],
