...
const resolversInfo = {
  ...
  Organization: ["organization", "findFirstOrganization", "organizations", "createOrganization", "createManyOrganization", "deleteOrganization", "updateOrganization", "deleteManyOrganization", "updateManyOrganization", "aggregateOrganization", "groupByOrganization"],
  Job: ["job", "findFirstJob", "jobs", "createJob", "createManyJob", "deleteJob", "updateJob", "deleteManyJob", "updateManyJob", "aggregateJob", "groupByJob"],
  JobApplicant: ["jobApplicant", "findFirstJobApplicant", "jobApplicants", "createJobApplicant", "createManyJobApplicant", "deleteJobApplicant", "updateJobApplicant", "deleteManyJobApplicant", "updateManyJobApplicant", "aggregateJobApplicant", "groupByJobApplicant"],
  Shift: ["shift", "findFirstShift", "shifts", "createShift", "createManyShift", "deleteShift", "updateShift", "deleteManyShift", "updateManyShift", "aggregateShift", "groupByShift"]
};
const relationResolversInfo = {
  OauthConnection: ["user"],
  TokenPair: ["user"],
  User: ["profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserProfile: ["user", "labels"],
  Post: ["likers", "comments", "attachments", "creator"],
  Comment: ["creator", "post", "report", "likers"],
  Attachment: ["post", "report"],
...
const modelsInfo = {
  ...
  Attachment: ["id", "attachmentUrl", "type", "postId", "reportId"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "profileId", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  AttachmentWhereInput: ["AND", "OR", "NOT", "id", "attachmentUrl", "type", "post", "postId", "report", "reportId"],
  AttachmentOrderByInput: ["id", "attachmentUrl", "type", "postId", "reportId"],
  AttachmentWhereUniqueInput: ["id"],
  AttachmentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "attachmentUrl", "type", "postId", "reportId"],
  ...
  OrganizationWhereInput: ["AND", "OR", "NOT", "id"],
  OrganizationOrderByInput: ["id"],
  OrganizationWhereUniqueInput: ["id"],
  OrganizationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id"],
  JobWhereInput: ["AND", "OR", "NOT", "id"],
  JobOrderByInput: ["id"],
  JobWhereUniqueInput: ["id"],
  JobScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id"],
  JobApplicantWhereInput: ["AND", "OR", "NOT", "id"],
  JobApplicantOrderByInput: ["id"],
  JobApplicantWhereUniqueInput: ["id"],
  JobApplicantScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id"],
  ShiftWhereInput: ["AND", "OR", "NOT", "id"],
  ShiftOrderByInput: ["id"],
  ShiftWhereUniqueInput: ["id"],
  ShiftScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id"],
  ...
  UserCreateInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserUpdateInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  AttachmentCreateInput: ["id", "attachmentUrl", "type", "post", "report"],
  AttachmentUpdateInput: ["attachmentUrl", "type", "post", "report"],
  AttachmentCreateManyInput: ["id", "attachmentUrl", "type", "postId", "reportId"],
  AttachmentUpdateManyMutationInput: ["attachmentUrl", "type"],
  ...
  OrganizationCreateInput: ["id"],
  OrganizationCreateManyInput: ["id"],
  OrganizationUpdateInput: [],
  OrganizationUpdateManyMutationInput: [],
  JobCreateInput: ["id"],
  JobCreateManyInput: ["id"],
  JobUpdateInput: [],
  JobUpdateManyMutationInput: [],
  JobApplicantCreateInput: ["id"],
  JobApplicantCreateManyInput: ["id"],
  JobApplicantUpdateInput: [],
  JobApplicantUpdateManyMutationInput: [],
  ShiftCreateInput: ["id"],
  ShiftCreateManyInput: ["id"],
  ShiftUpdateInput: [],
  ShiftUpdateManyMutationInput: [],
  ...
  ReportUpdateOneRequiredWithoutAttachmentsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  UserCreateWithoutOauthConnectionsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "tokens"],
  UserCreateOrConnectWithoutOauthConnectionsInput: ["where", "create"],
  UserUpsertWithoutOauthConnectionsInput: ["update", "create"],
  UserUpdateWithoutOauthConnectionsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "tokens"],
  UserCreateWithoutTokensInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections"],
  UserCreateOrConnectWithoutTokensInput: ["where", "create"],
  UserUpsertWithoutTokensInput: ["update", "create"],
  UserUpdateWithoutTokensInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections"],
  ...
  UserCreateWithoutFollowersInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutFollowersInput: ["where", "create"],
  UserCreateWithoutFollowingInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  UserCreateWithoutProfileInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutProfileInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  UserCreateWithoutLikedPostsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  AttachmentCreateWithoutPostInput: ["id", "attachmentUrl", "type", "report"],
  AttachmentCreateOrConnectWithoutPostInput: ["where", "create"],
  AttachmentCreateManyPostInputEnvelope: ["data"],
  UserCreateWithoutPostsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  AttachmentScalarWhereInput: ["AND", "OR", "NOT", "id", "attachmentUrl", "type", "postId", "reportId"],
  UserUpsertWithoutPostsInput: ["update", "create"],
  UserUpdateWithoutPostsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserCreateWithoutCreatedCommentsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  UserCreateWithoutLikedCommentsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutLikedCommentsInput: ["where", "create"],
  UserUpsertWithoutCreatedCommentsInput: ["update", "create"],
  UserUpdateWithoutCreatedCommentsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "likedPosts", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  UserCreateWithoutCreatedLabelsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "reports", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutCreatedLabelsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "reports", "oauthConnections", "tokens"],
  UserProfileUpsertWithoutLabelsInput: ["update", "create"],
  UserProfileUpdateWithoutLabelsInput: ["updatedAt", "status", "avatarUrl", "bio", "user"],
  UserCreateWithoutReportsInput: ["id", "createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "oauthConnections", "tokens"],
  UserCreateOrConnectWithoutReportsInput: ["where", "create"],
  AttachmentCreateWithoutReportInput: ["id", "attachmentUrl", "type", "post"],
  ...
  UserUpdateWithoutReportsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "followers", "createdLabels", "oauthConnections", "tokens"],
  ...
  UserUpdateWithoutFollowersInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "following", "createdLabels", "reports", "oauthConnections", "tokens"],
  UserUpdateWithoutFollowingInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "likedComments", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  ...
  AttachmentCreateManyPostInput: ["id", "attachmentUrl", "type", "reportId"],
  UserUpdateWithoutLikedPostsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedComments", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  CommentUpdateWithoutPostInput: ["createdAt", "updatedAt", "body", "edited", "likes", "creator", "report", "likers"],
  AttachmentUpdateWithoutPostInput: ["attachmentUrl", "type", "report"],
  UserUpdateWithoutLikedCommentsInput: ["createdAt", "updatedAt", "isLocal", "username", "displayName", "email", "password", "userRole", "profile", "posts", "createdComments", "likedPosts", "following", "followers", "createdLabels", "reports", "oauthConnections", "tokens"],
  AttachmentCreateManyReportInput: ["id", "attachmentUrl", "type", "postId"],
  CommentCreateManyReportInput: ["id", "createdAt", "updatedAt", "body", "creatorId", "postId", "edited", "likes"],
  AttachmentUpdateWithoutReportInput: ["attachmentUrl", "type", "post"],
...
const outputsInfo = {
  ...
  AttachmentGroupBy: ["id", "attachmentUrl", "type", "postId", "reportId", "_count", "_min", "_max"],
  ...
  OrganizationGroupBy: ["id", "_count", "_min", "_max"],
  AggregateJob: ["_count", "_min", "_max"],
  JobGroupBy: ["id", "_count", "_min", "_max"],
  AggregateJobApplicant: ["_count", "_min", "_max"],
  JobApplicantGroupBy: ["id", "_count", "_min", "_max"],
  AggregateShift: ["_count", "_min", "_max"],
  ShiftGroupBy: ["id", "_count", "_min", "_max"],
  ...
  AttachmentCountAggregate: ["id", "attachmentUrl", "type", "postId", "reportId", "_all"],
  AttachmentMinAggregate: ["id", "attachmentUrl", "type", "postId", "reportId"],
  AttachmentMaxAggregate: ["id", "attachmentUrl", "type", "postId", "reportId"],
  ...
  OrganizationCountAggregate: ["id", "_all"],
  OrganizationMinAggregate: ["id"],
  OrganizationMaxAggregate: ["id"],
  JobCountAggregate: ["id", "_all"],
  JobMinAggregate: ["id"],
  JobMaxAggregate: ["id"],
  JobApplicantCountAggregate: ["id", "_all"],
  JobApplicantMinAggregate: ["id"],
  JobApplicantMaxAggregate: ["id"],
  ShiftCountAggregate: ["id", "_all"],
  ShiftMinAggregate: ["id"],
  ShiftMaxAggregate: ["id"]
};
const argsInfo = {
