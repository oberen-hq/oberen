...
import { NestedEnumConnectionServiceWithAggregatesFilter } from "../inputs/NestedEnumConnectionServiceWithAggregatesFilter";
...
export class EnumConnectionServiceWithAggregatesFilter {
